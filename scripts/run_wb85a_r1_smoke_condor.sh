#!/usr/bin/env bash
# HTCondor worker for the WB85a-r1 official Calypso/ACTS runtime smoke.
# Plumbing only.  Does not authorize qualification or run WB86.
set -euo pipefail
...
python -u scripts/run_wb85a_r1_runtime_smoke.py --output-root "$output_root"
echo "=== WB85a-r1 runtime smoke completed ==="
