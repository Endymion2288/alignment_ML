#!/usr/bin/env python3
"""Submit one HTCondor job per WB87 source to dump ACTS C0/C1 on CKF 5x5."""
...
from datasets.acts_process_noise_contract import dump_path_for_source, load_config

PROJECT_ROOT = project_root()
WORKER = PROJECT_ROOT / "scripts" / "run_ckf_acts_process_noise_condor.sh"
...
def main() -> int:
    ...
    parser.add_argument("--submit-dir", default="outputs/acts_process_noise_contract_v1/condor")
    ...
    submit_file = submit_dir / "ckf_acts_process_noise.sub"
