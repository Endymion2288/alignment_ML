#!/usr/bin/env python3
"""Login-safe B14Y entry: inheritance and contract printout.

Does not launch Athena, does not enter B15, and does not submit 1989.
Official writes go through audit_focus86_segment_derivative_reference.py.
"""
...
def main() -> int:
    ...
    payload = {
        ...
        "inherited_wb123_jacobian_contract_established": inherited["workbook_123"][
