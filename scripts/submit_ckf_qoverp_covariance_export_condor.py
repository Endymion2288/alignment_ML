#!/usr/bin/env python3
"""Submit one HTCondor job per WB87 source to dump persisted CKF 5x5."""
...
from datasets.qoverp_covariance_export import dump_path_for_source, load_config

PROJECT_ROOT = project_root()
WORKER = PROJECT_ROOT / "scripts" / "run_ckf_qoverp_covariance_export_condor.sh"
...
def main() -> int:
    ...
    parser.add_argument("--submit-dir", default="outputs/qoverp_covariance_export_v1/condor")
    ...
    submit_file = submit_dir / "ckf_qoverp_covariance_export.sub"
