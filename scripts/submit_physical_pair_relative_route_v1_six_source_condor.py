#!/usr/bin/env python3
"""Submit Workbook-75 full six-source Physical Pair-Relative training to HTCondor.

One GPU job.  Architecture / loss / B / solver / OP are frozen from Workbook 74.
Logs stay under the project output tree.  Interactive lxplus GPUs are not used.
"""
...
WORKER = PROJECT_ROOT / "scripts" / "run_physical_pair_relative_route_v1_six_source_condor.sh"
GPU_REQUIREMENT = (
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=str(
            PROJECT_ROOT
            / "outputs/mc24_four_station_physical_pair_relative_route_v1_six_source/training/condor"
        ),
    )
