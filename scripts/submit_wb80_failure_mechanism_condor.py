#!/usr/bin/env python3
"""Submit Workbook-80 Arm B failure-mechanism folds to Condor (CPU).

Same request as the formal Workbook-79 CPU jobs: 8 CPU, 32 GB, flavour
...
WORKER = PROJECT_ROOT / "scripts" / "run_wb80_failure_mechanism_condor.sh"
...
def main() -> None:
    ...
    parser.add_argument(
        "--submit-dir",
        default=str(PROJECT_ROOT / "outputs/mc24_four_station_wb80_failure_mechanism_v1/condor"),
    )
